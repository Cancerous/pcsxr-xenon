...
#else
#include "../libpcsxcore_df/plugins.h"
#include "../libpcsxcore_df/psxcommon.h"
...
long CDR__open(void) {
    ...
    //cdfile "uda:/psxisos/Tekken 3 (USA)/Tekken 3 (USA) (Track 1).bin"
    strcpy(CDConfiguration.dn, "uda:/psxisos");
    strcpy(CDConfiguration.fn, "/Soul Blade (USA) (v1.1).bin");
