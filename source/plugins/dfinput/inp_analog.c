                    ...
                    case AXIS:
                        ...
                        if (g.cfg.PadDef[i].AnalogDef[j][k].J.Axis > 0) {
                            ...
                            if (val >= 0) {
                                ...
                                switch (k) {
                                    case ANALOG_XP: g.PadState[i].AnalogStatus[j][0] = val;
                                        break;
                                    case ANALOG_XM: g.PadState[i].AnalogStatus[j][0] = 255 - val;
                                        break;
                                    case ANALOG_YP: g.PadState[i].AnalogStatus[j][1] = val;
                                        break;
                                    case ANALOG_YM: g.PadState[i].AnalogStatus[j][1] = 255 - val;
                                        break;
                                }
                            }
                            ...
                            if (val <= 0) {
                                ...
                                switch (k) {
                                    case ANALOG_XP: g.PadState[i].AnalogStatus[j][0] = 255 - val;
                                        break;
                                    case ANALOG_XM: g.PadState[i].AnalogStatus[j][0] = val;
                                        break;
                                    case ANALOG_YP: g.PadState[i].AnalogStatus[j][1] = 255 - val;
                                        break;
                                    case ANALOG_YM: g.PadState[i].AnalogStatus[j][1] = val;
                                        break;
                                }
                            }
                        }
