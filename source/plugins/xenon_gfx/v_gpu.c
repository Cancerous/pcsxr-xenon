...
long GPUopen(unsigned long * disp, char * CapText, char * CfgFile) {
    ...
    printf("Compile flags __PPC__ = %D, __BIG_ENDIAN__=%d \r\n",
#ifdef __PPC__
            1
#else
            0
...
/*
    printf("GPUupdateLace : FPS %06.1f\r\n", fps_cur);
    
    // Dump psxdisplay info
    printf("PSXDISPLAY:\r\n");
    printf("\tPSXDisplay.Interlaced:%d\r\n",PSXDisplay.Interlaced);
    printf("\tPSXDisplay.Disabled:%d\r\n",PSXDisplay.Disabled);
    printf("\tPSXDisplay.RGB24:%d\r\n",PSXDisplay.RGB24);
    printf("\tPSXDisplay.DisplayMode.x:%d\r\n",PSXDisplay.DisplayMode.x);
    printf("\tPSXDisplay.DisplayMode.y:%d\r\n",PSXDisplay.DisplayMode.y);
 */ 
    ShowFPS();
#if 1    
